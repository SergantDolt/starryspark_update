...
import com.gullible.content.entities.boulders.AbstractBoulderEntity;
...
public class MegaDamageBananaBoulderRenderer extends EntityRenderer<MegaDamageBananaBoulder> {
    private final BlockRenderDispatcher dispatcher;

    public MegaDamageBananaBoulderRenderer(EntityRendererProvider.Context context) {
        super(context);
        this.dispatcher = context.getBlockRenderDispatcher();
    }

    @Override
    public ResourceLocation getTextureLocation(MegaDamageBananaBoulder entity) {
        return StarrysparkUpdate.ModLocation("textures/block/banana_boulder_grenade.png");
    }

    @Override
    public void render(MegaDamageBananaBoulder entity, float f, float g, PoseStack poseStack, MultiBufferSource multiBufferSource, int i) {
